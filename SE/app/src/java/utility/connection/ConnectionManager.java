...
public class ConnectionManager {
    ...
    public static void clearDatabase() {
        ...
        try {
            conn = getConnection();
            pstmt = conn.prepareStatement("delete from section_student");
            pstmt.execute();
            pstmt = conn.prepareStatement("delete from bid");
            pstmt.execute();
            pstmt = conn.prepareStatement("delete from section");
            pstmt.execute();
            pstmt = conn.prepareStatement("delete from course_completed");
            pstmt.execute();
            pstmt = conn.prepareStatement("delete from prerequisite");
            pstmt.execute();
            pstmt = conn.prepareStatement("delete from course");
            pstmt.execute();
            pstmt = conn.prepareStatement("delete from student");
            pstmt.execute();
        } catch (SQLException e) {
            System.out.println("delete from db error: " + e.getMessage());
        }
        finally{
            close(conn, pstmt, rs);
        }
